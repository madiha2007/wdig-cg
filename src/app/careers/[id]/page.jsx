  ...
  return (
    <div style={{ background: "#f0f6ff", fontFamily: "'DM Sans', sans-serif" }}>
      ...
      <div style={{
        ...
        <div style={{ position: "relative", maxWidth: 1100, margin: "0 auto", padding: "40px 24px 48px" }}>

          {/* Back link */}
          <Link href="/explore" className="back-link au" style={{
            display: "inline-flex", alignItems: "center", gap: 6,
            color: "#3b82f6", fontSize: 13, fontWeight: 700, textDecoration: "none",
            marginBottom: 28, background: "rgba(255,255,255,0.7)", backdropFilter: "blur(8px)",
          ...
          {/* Badges */}
          <div className="au" style={{ display: "flex", gap: 8, flexWrap: "wrap", marginBottom: 16, animationDelay: "0.05s" }}>
            {career.bright_outlook && (
              <span style={{ display: "inline-flex", alignItems: "center", gap: 5, background: "#fef9c3", border: "1.5px solid #fde047", color: "#854d0e", borderRadius: 100, padding: "5px 14px", fontSize: 12, fontWeight: 700 }}>
                <Star size={10} fill="#eab308" color="#eab308" /> Bright Outlook
              </span>
            )}
            {career.in_demand && (
              <span style={{ background: "#dcfce7", border: "1.5px solid #86efac", color: "#166534", borderRadius: 100, padding: "5px 14px", fontSize: 12, fontWeight: 700 }}>🔥 In Demand</span>
            )}
            {career.outlook_category && (
              <span style={{ background: outlookMeta.bg, border: `1.5px solid ${outlookMeta.border}`, color: outlookMeta.text, borderRadius: 100, padding: "5px 14px", fontSize: 12, fontWeight: 700 }}>{outlookMeta.label}</span>
            )}
            <span style={{ background: "rgba(255,255,255,0.8)", border: "1px solid #e0e7ff", color: "#6366f1", borderRadius: 100, padding: "5px 14px", fontSize: 12, fontWeight: 600, fontFamily: "'DM Mono', monospace" }}>
              O*NET {career.code}
            </span>
          </div>

          {/* Title */}
          <h1 className="au" style={{ fontFamily: "'Fraunces', Georgia, serif", fontWeight: 900, color: "#1e3a5f", fontSize: "clamp(30px, 5vw, 52px)", lineHeight: 1.1, maxWidth: 700, animationDelay: "0.1s" }}>
            {career.title}
          </h1>
          {career.also_called.length > 0 && (
            <p className="au" style={{ color: "#64748b", fontSize: 14, marginTop: 10, animationDelay: "0.15s" }}>
          ...
          {/* Salary Cards */}
          {career.salary && (
            <div className="au" style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(150px, 1fr))", gap: 12, marginTop: 32, animationDelay: "0.2s" }}>
              {[
                ...
                <div key={s.label} style={{
                  ...
                  <div style={{ width: 36, height: 36, borderRadius: 10, margin: "0 auto 10px", background: s.accentBg, display: "flex", alignItems: "center", justifyContent: "center", fontSize: 18, border: `1px solid ${s.accentBorder}` }}>{s.icon}</div>
                  <div style={{ fontSize: s.big ? 22 : 18, fontWeight: 900, color: "#111827", fontFamily: "'DM Mono', monospace" }}>{s.value}</div>
      ...
      <div style={{ maxWidth: 1100, margin: "0 auto", padding: "36px 24px 60px", display: "grid", gridTemplateColumns: "1fr 340px", gap: 24, alignItems: "start" }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
          ...
          {/* About */}
          {career.description && (
            <div className="au" style={{ background: "#fff", borderRadius: 20, border: "1.5px solid #e0e7ff", padding: "28px", boxShadow: "0 2px 12px rgba(59,130,246,0.06)", borderLeft: "5px solid #3b82f6", animationDelay: "0.25s" }}>
              <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 16 }}>
                ...
                <h2 style={{ fontSize: 16, fontWeight: 800, color: "#1e3a5f", fontFamily: "'Fraunces', serif" }}>About This Career</h2>
              </div>
          ...
          {career.tasks.length > 0 && (
            <div className="au" style={{ background: "#fff", borderRadius: 20, border: "1.5px solid #e5e7eb", padding: "28px", boxShadow: "0 2px 12px rgba(0,0,0,0.04)", animationDelay: "0.35s" }}>
              <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 20 }}>
                <div style={{ width: 34, height: 34, borderRadius: 10, background: "#fef3c7", border: "1px solid #fde68a", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 17 }}>⚡</div>
                <h2 style={{ fontSize: 16, fontWeight: 800, color: "#1e3a5f", fontFamily: "'Fraunces', serif" }}>What You'll Do Day-to-Day</h2>
              </div>
          ...
          {/* Skills — varying visual weight */}
          {career.skills.length > 0 && (
            <div className="au" style={{ background: "#fff", borderRadius: 20, border: "1.5px solid #e5e7eb", padding: "28px", boxShadow: "0 2px 12px rgba(0,0,0,0.04)", animationDelay: "0.4s" }}>
              <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 20 }}>
                <div style={{ width: 34, height: 34, borderRadius: 10, background: "#ede9fe", border: "1px solid #ddd6fe", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 17 }}>🛠</div>
                <h2 style={{ fontSize: 16, fontWeight: 800, color: "#1e3a5f", fontFamily: "'Fraunces', serif" }}>Top Skills Required</h2>
              </div>
              <div style={{ display: "flex", flexWrap: "wrap", gap: 10 }}>
                {career.skills.map((skill, i) => (
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 16, position: "sticky", top: 24 }}>
          ...
          {/* Education with progress bars */}
          {career.education.length > 0 && (
            <div className="au" style={{ background: "#fff", borderRadius: 20, border: "1.5px solid #e5e7eb", padding: "22px", boxShadow: "0 2px 12px rgba(0,0,0,0.04)", animationDelay: "0.3s" }}>
              <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 18 }}>
                <div style={{ width: 36, height: 36, borderRadius: 12, background: "linear-gradient(135deg, #3b82f6, #6366f1)", display: "flex", alignItems: "center", justifyContent: "center" }}>
          ...
          {/* Knowledge — colorful tiles */}
          {career.knowledge.length > 0 && (
            <div className="au" style={{ background: "#fff", borderRadius: 20, border: "1.5px solid #e5e7eb", padding: "22px", boxShadow: "0 2px 12px rgba(0,0,0,0.04)", animationDelay: "0.35s" }}>
              <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 16 }}>
          ...
          {/* Quick Facts */}
          <div className="au" style={{ background: "linear-gradient(135deg, #eff6ff, #e0f2fe)", borderRadius: 20, border: "1.5px solid #bfdbfe", padding: "20px 22px", animationDelay: "0.4s" }}>
            <h3 style={{ fontSize: 12, fontWeight: 800, color: "#1e3a5f", marginBottom: 14, textTransform: "uppercase", letterSpacing: "0.07em" }}>Quick Facts</h3>
            <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
              {[
                ...
                <div key={f.label} style={{ display: "flex", alignItems: "center", justifyContent: "space-between", padding: "8px 12px", background: "rgba(255,255,255,0.75)", borderRadius: 10, border: "1px solid #dbeafe" }}>
          ...
          {/* CTA */}
          <div className="au" style={{ background: "linear-gradient(135deg, #1e3a5f, #1d4ed8)", borderRadius: 20, padding: "24px 20px", textAlign: "center", boxShadow: "0 8px 28px rgba(29,78,216,0.25)", animationDelay: "0.45s", position: "relative", overflow: "hidden" }}>
            ...
            <p style={{ color: "rgba(255,255,255,0.6)", fontSize: 12, lineHeight: 1.6, marginBottom: 18 }}>
            ...
            <p style={{ color: "rgba(255,255,255,0.3)", fontSize: 11, marginTop: 12 }}>Data: O*NET · U.S. Dept. of Labor</p>
          </div>
        </div>
      </div>
    </div>
